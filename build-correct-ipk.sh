...
# Correct IPK Package Builder
# Based on working ntpd package format (tar archive, not ar archive)
...
BUILD_DIR="/home/markusla/correct-ipk-build"
TIMESTAMP=$(date +%s)

echo "Building Correct IPK Packages (Tar Format)"
