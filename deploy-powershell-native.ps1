# PowerShell Native VUCI Package Deployment
# Uses PowerShell's built-in SSH/SCP instead of WSL
...
Write-Host "Deploying VUCI Packages to RUTOS (PowerShell Native)" -ForegroundColor Green
...
wsl bash -c "cp /home/markusla/complete-vuci-build/*.ipk /mnt/c/temp/rutos-packages/"
