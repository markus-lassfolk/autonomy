                           ...
                           struct blob_attr *msg)
{
    ...
    blobmsg_add_f32(&bb, "network_health_score", g_state.network_health_score);
                               ...
                               struct blob_attr *msg)
{
    ...
    for (int i = 0; i < g_state.interface_count; i++) {
        ...
        blobmsg_add_f32(&bb, "latency", g_state.interfaces[i].latency);
        blobmsg_add_f32(&bb, "loss", g_state.interfaces[i].loss);
