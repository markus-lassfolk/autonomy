...
static const struct blobmsg_policy cluster_policy[] = {
    ...
    [7] = { .name = "reason", .type = BLOBMSG_TYPE_STRING },
};
                                    ...
                                    struct blob_attr *msg)
{
    ...
    int status_result = starlink_cluster_get_status(&cluster);
    if (status_result == 0) {
        ...
        blobmsg_add_u32(&bb, "error_code", status_result);
    }
