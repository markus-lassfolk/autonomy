...
#define printf("INFO: fmt, ...) printf("[INFO] " fmt "\n", ##__VA_ARGS__)
#define printf("ERROR: fmt, ...) fprintf(stderr, "[ERROR] " fmt "\n", ##__VA_ARGS__)
#define printf("WARN: fmt, ...) printf("[WARN] " fmt "\n", ##__VA_ARGS__)
#define printf("DEBUG: fmt, ...) printf("[DEBUG] " fmt "\n", ##__VA_ARGS__)
#endif
...
int starlink_grpc_comprehensive_client_init(starlink_grpc_client_config_t *config) {
    ...
    printf("INFO: "Starlink gRPC comprehensive client initialized"\n"\n"\n"\n"\n"\n"\n"\n");
...
void starlink_grpc_comprehensive_client_cleanup(void) {
    ...
    curl_global_cleanup(\n"\n"\n"\n"\n"\n"\n"\n");
    printf("INFO: "Starlink gRPC comprehensive client cleaned up"\n"\n"\n"\n"\n"\n"\n"\n");
}
