...
static int calculate_system_overview(system_overview_t* overview);
static int calculate_performance_metrics(performance_metrics_t* performance);
static int calculate_health_metrics(health_metrics_t* health);
