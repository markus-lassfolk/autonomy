...
// Network interface structure - now using shared unified type
...
// Return codes - now using shared unified error codes

// GPS source types - now using shared unified enum
...
// GPS data structure - now using shared unified type
...
// Network metrics structure - now using shared unified type
