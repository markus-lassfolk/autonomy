...
echo "=== Building Manual VUCI Packages ==="
...
# Create control file for API package
...
# Create control file for UI package
...
mv "vuci-app-${PACKAGE_NAME}-api_${PACKAGE_VERSION}-${PACKAGE_RELEASE}_${ARCH}.ipk" ../
...
# Move to build directory
mv "vuci-app-${PACKAGE_NAME}-ui_${PACKAGE_VERSION}-${PACKAGE_RELEASE}_${ARCH}.ipk" ../
